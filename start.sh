...
if [ -z "`ls /etc/apache2 --hide='lost+found'`" ]; then cp -R /etc-start/apache2/* /etc/apache2; fi
if [ -z "`ls /etc/php --hide='lost+found'`" ]; then 
...
if [ -z "`ls /var/www --hide='lost+found'`" ]; then
