...
RUN apt-get update && \
    ...
    php5.6-mbstring php5.6-sqlite3 php5.6-sybase php5.6-bcmath php5.6-phpdbg php5.6-opcache \
    php5.6-bz2 php5.6-odbc php5.6-interbase php5.6-gmp php5.6-xsl php5.6-soap php5.6-xml && \
